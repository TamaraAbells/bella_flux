      ...
      <div class="flex flec-row justify-between items-start gap-20 py-5 px-10">
        <div class="flex flex-col justify-start gap-5">
          ...
          <div class="flex flex-row justify-start items-start gap-2">
            <img class="w-12 h-12 rounded-full border-2" :src="require(`../../assets/posts/posts/${post.id}.jpeg`)" />
          ...
          <div class="flex flex-col justify-start gap-5 tracking-6 leading-6">
            <img style="width:800px;height:600px" :src="require(`../../assets/posts/posts/${post.id}.jpeg`)" />
...
export default {
  ...
  methods: {
    async bootstrap(){
      ...
      await this.$axios.get(`https://jsonplaceholder.typicode.com/posts/${this.$route.params.id}`)
